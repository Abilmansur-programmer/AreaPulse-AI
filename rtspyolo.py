...
class DetectionSystem:
    def __init__(self, video_path):
        ...
        # Initialize zones
        self.zones = [
            Zone(1, 150, 200, 200, 100),    # zone_rect_right
            Zone(2, 410, 90, 100, 100)    # zone_rect_comparison
        ]
    ...
    def process_frame(self, frame):
        ...
        if self.current_mode == self.MODE_PEOPLE:
            ...
            for zone in self.zones:
                ...
                label = "Left" if zone.id == 1 else "Right"
...
def main():
    video_path = "rtsp://MainWave:MainWave2025@10.8.23.172:554/stream2"
